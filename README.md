...
jobs:
  pinprick:
    ...
    steps:
      ...
      - name: Run pinprick
        uses: starhaven-io/pinprick-action@a7914d669a5a3c940adf255867cbf6f910960edd # v0.6.4
        with:
          no-repo-config: true
```
...
| --- | --- | --- |
| `version` | `0.25.1` | pinprick version to install, pinned by default for deterministic runs. Use `latest` for the newest, or an exact version like `v0.25.1`. |
